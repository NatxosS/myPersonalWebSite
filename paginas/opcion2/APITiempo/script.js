...
var ubicacion;
        ...
        function mostrarError(error) {  // función que muestra el error si se produce al buscar las coordenadas
            
            $("#mapa").html('<div><h5 class="left-align">ERROR(' + error.code + '): ' + error.message +'</h5></div>');
        }
...
$(function () {
        ...
        $("#manana").click(function (evet) {
            ...
            $("#conUbicacion").click(function (evento) {
                ...
                if ("geolocation" in navigator) {        // si esta activada la geolocalización llevamos a cabo nuestra tarea
                    ...
                    var latitud; 
                    var longitud;
                                            // indicamos unas opciones en la petición de las coordenadas, como el Timeout
                    var geo_options = {
                  ...
                  // mientras se carga mostramos el gif de carga
                        ...
                        // $.get es el método que realiza la petición de ajaxTiene dos parámetros
                        var url = "http://api.openweathermap.org/data/2.5/weather?lat="+latitud+"&lon="+longitud+"&units=metric&APPID=ffb471df7d035f86794800527efbb79c&lang=es";        
                        ...
                        var url = "http://api.openweathermap.org/data/2.5/forecast?lat="+latitud+"&lon="+longitud+"&mode=json&units=metric&cnt=2&appid=ffb471df7d035f86794800527efbb79c&lang=es";        
                    ...
                    }, mostrarError, geo_options);
                        // función llamada si se produce el error y las opciones
